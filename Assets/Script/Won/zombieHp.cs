...
public class zombieHp : MonoBehaviour
{
    ...
    float curret_zombie_hp;//현재 좀비의 체력
    ...
    public float easy_speed = 7;//약한 좀비의 이동 속도
    public float normal_speed = 10;//보통 좀비의 이동 속도
    public float hard_speed = 13;//강한 좀비의 이동 속도
